    ...
    <ul id="gallery">
      ...
      <li>
        <form method="post" action='<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>'>
          ...
          出生年月  /  Day Of Birth (填写格式：日.月.年 ｜ dd.mm.yyyy)
          <br>
          ...
          <!-- 如果所有输入结果正确，则执行record -->
          <?php if($all_pass < 7){
                    echo "<script type='text/javascript'>alert('Error:Need to fill again! 有地方填写错误，请按照提示重新填写。');</script>";
                  }
                if($all_pass === 7){
                    include 'record.php';
                  }
